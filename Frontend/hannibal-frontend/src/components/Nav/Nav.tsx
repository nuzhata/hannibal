        ...
        {matches ? (
          <>
            <Typography variant="h6" color="inherit" noWrap className={classes.toolbarTitle}>
              {/* <a className={ classes.brandLink } href="/">Hannibal Finance</a> */}
              
              {/* <Link to="/" color="inherit" className={classes.brandLink}>
              Hannibal Finance
              </Link> */}
            <Logo href={'/'} target="_blank">
              <img style={{ width: '37%' }} src={logo} />
            </Logo>
            </Typography>

            <Box  style={{ position: 'absolute', top: '50%', left: '100px', transform: 'translate(-0%, -50%)' }}>
