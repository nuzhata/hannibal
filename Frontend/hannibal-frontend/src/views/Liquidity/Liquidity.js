...
const ProvideLiquidity = () => {
  ...
  const tombBalance = useTokenBalance(tombFinance.Han);
  ...
  const handleTombChange = async (e) => {
    ...
    setTombAmount(e.currentTarget.value);
    const quoteFromSpooky = await tombFinance.quoteFromSpooky(e.currentTarget.value, 'HAN');
  ...
  const handleTombSelectMax = async () => {
    const quoteFromSpooky = await tombFinance.quoteFromSpooky(getDisplayBalance(tombBalance), 'HAN');
                ...
                <Grid item xs={12} sm={12} style={{ borderRadius: 15 }}>
                  <Box p={4}>
                    <Grid container>
                      ...
                      <Grid item xs={12}>
                        <p>1 HAN = {tombPriceInFTM} FTM</p>
                        <p>1 FTM = {ftmPriceInTOMB} HAN</p>
