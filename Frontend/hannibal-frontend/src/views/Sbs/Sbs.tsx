...
const Sbs: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(tombFinance.HaBOND, tombFinance.contracts.TShareSwapper.address);
        ...
        {!!account ? (
          <>
            <Route exact path={path}>
              <PageHeader icon={'🏦'} title="HaBond -> HaShare Swap" subtitle="Swap HaBond to HaShare" />
            </Route>
            <Box mt={5}>
                  ...
                  <StyledCardsWrapper>
                      ...
                      <Card>
                        <CardContent>
                          <StyledCardContentInner>
                            <StyledCardTitle>HaBonds</StyledCardTitle>
                            <StyledExchanger>
                              <StyledToken>
                                <StyledCardIcon>
                                  <TokenSymbol symbol={tombFinance.HaBOND.symbol} size={54} />
                                </StyledCardIcon>
                              </StyledToken>
                            </StyledExchanger>
                            <Grid item xs={12}>
                            ...
                            <StyledDesc>{`${bondBalance} HaBOND Available in Wallet`}</StyledDesc>
                          </StyledCardContentInner>
                        </CardContent>
                      </Card>
                    </StyledCardWrapper>
                    ...
                    <StyledCardWrapper>
                      <Card>
                        <CardContent>
                          <StyledCardContentInner>
                            <StyledCardTitle>HaShare</StyledCardTitle>
                            <StyledExchanger>
                              <StyledToken>
                                <StyledCardIcon>
                                  <TokenSymbol symbol={tombFinance.HaSHARE.symbol} size={54} />
                                </StyledCardIcon>
                              </StyledToken>
                            </StyledExchanger>
                            <Grid item xs={12}>
                            ...
                            <StyledDesc>{`${tshareBalance} HaSHARE Available in Swapper`}</StyledDesc>
                          </StyledCardContentInner>
                        </CardContent>
                      </Card>
