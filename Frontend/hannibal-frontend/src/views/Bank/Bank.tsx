...
const LPTokenHelpText: React.FC<{ bank: BankEntity }> = ({ bank }) => {
  ...
  const tombAddr = tombFinance.Han.address;
  const tshareAddr = tombFinance.HaSHARE.address;

  let pairName: string;
  let uniswapUrl: string;
  if (bank.depositTokenName.includes('HAN')) {
    pairName = 'HAN-FTM pair';
    uniswapUrl = 'https://spookyswap.finance/add/FTM/' + tombAddr;
  } else {
    pairName = 'HaSHARE-FTM pair';
