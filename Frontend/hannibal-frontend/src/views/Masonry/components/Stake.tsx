...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(tombFinance.HaSHARE, tombFinance.contracts.Masonry.address);

  const tokenBalance = useTokenBalance(tombFinance.HaSHARE);
  const stakedBalance = useStakedBalanceOnMasonry();
  const { from, to } = useUnstakeTimerMasonry();

  const stakedTokenPriceInDollars = useStakedTokenPriceInDollars('HaSHARE', tombFinance.HaSHARE);
